#!/usr/bin/env python3
"""
MindCoach Chat Monitor — Trigger-based response system.
Polls Cloud Run /api/chat for new user messages.
Auto-resets state on detectada inconsistência.
"""
...
if __name__ == "__main__":
    ...
    # Auto-fix: se state.last_id > api_last_id, dados foram resetados (redeploy)
