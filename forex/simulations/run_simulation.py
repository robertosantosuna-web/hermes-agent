#!/usr/bin/env python3
"""EURUSD M15 Pattern Simulation — CHoCH, FVG, BOS with WIN/LOSS analysis."""
...
def main():
    print("=" * 60)
    print("EURUSD M15 Pattern Simulation")
    print("=" * 60)

    # Download data
    print("\n[1/4] Downloading EURUSD M15 data (30 days)...")
    candles = download_pair_m15('EURUSD', 30)
    ...
    # Save
    output_path = HERMES / 'forex' / 'simulations' / 'hermes_eurusd_analysis.json'
